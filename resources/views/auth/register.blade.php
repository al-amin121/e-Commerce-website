    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username"></x-input>
            </div>

            <div class="mt-4">
                <x-label for="phone" value="{{ __('phone') }}"></x-label>
                <x-input id="phone" class="block mt-1 w-full" type="number" name="phone" :value="old('phone')" required autocomplete="phone"></x-input>
            </div>

            <div class="mt-4">
                <x-label for="address" value="{{ __('address') }}"></x-label>
                <x-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address')"  autocomplete="address"></x-input>
            </div>
